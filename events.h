...
typedef struct message* LeftMouseDownEventPtr;

#define kEventRightMouseDown 0x1057ac50
typedef struct message* RightMouseDownEventPtr;

#define kEventOtherMouseDown 0x9822ca20
typedef struct message* OtherMouseDownEventPtr;

#define kEventLeftMouseUp 0xf73e019e
typedef struct message* LeftMouseUpEventPtr;

#define kEventRightMouseUp 0x9160ff69
typedef struct message* RightMouseUpEventPtr;

#define kEventOtherMouseUp 0x567302d9
typedef struct message* OtherMouseUpEventPtr;

#define kEventLeftMouseDragged 0x088e1f1b
typedef struct message* LeftMouseDraggedEventPtr;

#define kEventRightMouseDragged 0x29d4da42
typedef struct message* RightMouseDraggedEventPtr;

#define kEventOtherMouseDragged 0x0ae3dd32
typedef struct message* OtherMouseDraggedEventPtr;

#define kEventLeftDoubleClick 0x5a92bc67
typedef struct message* LeftDoubleClickEventPtr;

#define kEventRightDoubleClick 0xeeebbe60
typedef struct message* RightDoubleClickEventPtr;

#define kEventOtherDoubleClick 0xf6c60630
typedef struct message* OtherDoubleClickEventPtr;

#define kEventMouseMoved 0x65db8b6f
typedef struct message* MouseMovedEventPtr;

#define kEventScrollWheel 0x626f90e3
typedef struct message* ScrollWheelEventPtr;

#define kEventDragDrop 0x25989e7a
typedef struct message* DragDropEventPtr;

#define kEventDragEnter 0xc0e97a77
typedef struct message* DragEnterEventPtr;

#define kEventKeyDown 0x83b19b78
typedef struct message* KeyDownEventPtr;

#define kEventKeyUp 0xfca37d71
typedef struct message* KeyUpEventPtr;

#define kEventChar 0x2879e23d
typedef struct message* CharEventPtr;
